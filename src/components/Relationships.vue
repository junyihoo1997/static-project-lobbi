<template>
  <div class="relationship-layout">
    <div class="relationship-items container">
      <div class="relationship-section-left">
        <div class="relationship-image-container">
          <img
            :src="require('@/assets/images/RelationshipImage.png')"
